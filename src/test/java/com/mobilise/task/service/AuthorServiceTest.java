...
class AuthorServiceTest {
    ...
    @Test
    void createAuthorTest() throws GenericException {
        when(authorRepository.save(any(Author.class))).thenReturn(savedAuthor);
    ...
    @Test
    void deleteAuthorTest() throws GenericException {
        when(authorRepository.findById(anyLong())).thenReturn(Optional.of(savedAuthor));
    ...
    @Test
    void updateAuthorTest() throws GenericException, InvocationTargetException, IllegalAccessException {
    ...
    void findAllTest() {
        ...
        Map<String, Object> result = authorService.findAll(0, 1);
